    ...
    private void sendMessage(){
        ...
        if(!isReceiverAvailable){
            try {
                ...
                data.put(Constants.KEY_FOR_TOKEN,preferenceManager.getString(Constants.KEY_FOR_TOKEN));
    ...
    private void listenAvailabilityReceiver(){
        database.collection(Constants.KEY_COLLECTION_USERS).document(
            ...
            if(error!=null){
                ...
                receiverUser.token=value.getString(Constants.KEY_FOR_TOKEN);
                if(receiverUser.image==null){
                    receiverUser.image=value.getString(Constants.KEY_NAME);
                    chatAdapter.setReceivedProfileImage(getBitmapFromEncodedString(receiverUser.image));
