...
public class MainActivity extends BaseActivity implements ConversionListener {
    ...
    private void loadUserDetails(){
        ...
        binding.textName.setText((preferenceManager.getString(Constants.KEY_NAME)!=null?name:"no name"));
    ...
    private void updateToken(String token){
        preferenceManager.putString(Constants.KEY_FOR_TOKEN,token);
        FirebaseFirestore database=FirebaseFirestore.getInstance();
        DocumentReference documentReference=database.collection(Constants.KEY_COLLECTION_USERS).document(preferenceManager.getString(Constants.KEY_USER_ID));
        documentReference.update(Constants.KEY_FOR_TOKEN,token)
